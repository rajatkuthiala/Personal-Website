...
<div class="modal fade bs-modal-sm log-sign" id="myModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color:#273131fa">
        ...
        <div class="tab-pane fade active in" id="signin">
            ...
            <!-- Text input-->
               ...
               <div class="group">
<input id="usernameInput" required="" class="input" type="text"><span class="highlight"></span><span class="bar"></span>
    <label class="label" for="date">Email address</label></div>


            <!-- Password input-->
            <div class="group">
<input id="passwordInput" required="" class="input" type="password"><span class="highlight"></span><span class="bar"></span>
...
<em>minimum 6 characters</em>
           ...
           <div class="forgot-link">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <button id="signin" name="signin" class="btn btn-primary btn-block" onclick="dologin()">Log In</button>
              </div>
            </div>
            </fieldset>
            </form>
        ...
        <div class="tab-pane fade" id="signup">
            ...
            <!-- Text input-->
            <div class="group">
<input id="firstname_signup" required="" class="input" type="text"><span class="highlight"></span><span class="bar"></span>
    <label class="label" for="date">First Name</label></div>

            <!-- Text input-->
            <div class="group">
<input id="lastName_signup" required="" class="input" type="text"><span class="highlight"></span><span class="bar"></span>
    <label class="label" for="date">Last Name</label></div>

            <!-- Password input-->
            <div class="group">
<input id="email_signup" required="" class="input" type="text"><span class="highlight"></span><span class="bar"></span>
    <label class="label" for="date">Email</label></div>

            <!-- Text input-->
            <div class="group">
<input id="password_signup" required="" class="input" type="password"><span class="highlight"></span><span class="bar"></span>
    <label class="label" for="date">Password</label></div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <button id="confirmsignup" name="confirmsignup" class="btn btn-primary btn-block" onclick="do_signUp()">Sign Up</button>
              </div>
            </div>
            </fieldset>
            </form>
